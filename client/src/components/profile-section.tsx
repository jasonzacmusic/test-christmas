      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          {performances.length > 0 && (
            <div className="mt-20">
              <div className="text-center mb-12">
                <h3 className="text-4xl sm:text-5xl md:text-6xl font-bold text-primary mb-4" style={{ 
                  fontFamily: 'var(--font-christmas)',
                  letterSpacing: '0.03em',
                  textShadow: '0 2px 20px rgba(220, 38, 38, 0.3)'
                }}>
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto" style={{ fontFamily: 'var(--font-elegant)' }}>
                ...
                >
                  {performances.map((video) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="text-lg font-semibold text-card-foreground mb-2 line-clamp-2" style={{ fontFamily: 'var(--font-elegant)' }}>
                          {video.title}
                        </h3>
