...
export function ProfileSection() {
  ...
  const fairytaleVideo = randomizedVideos.find(v => 
    v.type === 'performance' && v.title.toLowerCase().includes('fairytale')
  );
  
  const narayanVideo = randomizedVideos.find(v => 
    v.type === 'performance' && (v.title.toLowerCase().includes('narayan') || v.description.toLowerCase().includes('narayan'))
  );
